...
public class UserXMLUser {
    ...
    @Test
    public void advanceSearchWithXMLAndJavaAndString() {
        String nome = given()
                .when()
                .get("/usersXML")
                .then()
    ...
    @Test
    public void advanceSearchWithXMLAndJavaAndStringArrayList() {
        ArrayList<String> path = given()
                .when()
                .get("/usersXML")
                .then()
                .statusCode(200)
    ...
    @Test
    public void advanceSearchWithXMLAndJavaAndStringUpperCase() {
