...
public class UserJsonTest {
	...
	public void checkAdvanced(){
		given()
				...
				.body("findAll{it.name.length() > 10}.name",hasItems("Maria Joaquina", "Ana Júlia"))
				...
				.body("salary.findAll{it != null}.sum()",allOf(greaterThan(3000d), lessThan(5000d))) // boa prática
		;
	}
	...
	public void LinkJsonPathwithJava(){
		...
		Assert.assertTrue(names.get(0).equalsIgnoreCase("mArIa")); // não é amigável
